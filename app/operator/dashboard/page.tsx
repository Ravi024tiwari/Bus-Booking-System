...
import OperatorDashboardClient from './dashboard-client';
...
export default async function OperatorDashboardPage() {
  ...
  try {
    ...
    console.error('[Operator Dashboard Server] Auth check error:', err);
    redirect('/login');
  }
  ...
  return (
    <OperatorDashboardClient operatorName={firstName} />
  );
}
