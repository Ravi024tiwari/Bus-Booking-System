...
import BusDetailView from "../bus-detail-view";
import UnverifiedOperator from '../../dashboard/unverified-operator';

export const dynamic = 'force-dynamic';

interface OperatorBusDetailPageProps {
  params: Promise<{ busId: string }>;
}

export default async function OperatorBusDetailPage({ params }: OperatorBusDetailPageProps) {
  ...
  try {
    ...
    console.error('[Operator Bus Detail Server] Auth check error:', err);
    redirect('/login');
  }
