...
import AddBusClient from './add-bus-client';
import UnverifiedOperator from '../../dashboard/unverified-operator';

export const dynamic = 'force-dynamic';

export default async function OperatorAddBusPage() {
  ...
  try {
    ...
    console.error('[Operator Add Bus Server] Auth check error:', err);
    redirect('/login');
  }
  ...
  return (
    <AddBusClient operatorName={firstName} />
  );
}
