...
export default function Footer({ onNavigate }: FooterProps) {
  return (
    <footer id="contact" className="bg-[#0F172A] text-slate-400 pt-16 pb-12 border-t border-slate-800">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 grid grid-cols-2 md:grid-cols-6 gap-8 text-left">
        ...
        <div className="col-span-2 flex flex-col gap-3.5">
          <div className="flex items-center gap-2.5">
            <div className="bg-[#FF6B00] p-2 rounded-xl flex items-center justify-center shadow-md shadow-orange-500/20">
          ...
          <p className="text-xs text-slate-400 leading-relaxed max-w-sm">
            Your trusted partner for safe, reliable, and comfortable bus travel across the country. Simple online bookings and fast refund settlements on TripGo.
          </p>
        </div>
        ...
        <div className="col-span-2 sm:col-span-1 flex flex-col gap-3">
          ...
          <ul className="flex flex-col gap-2.5 text-xs text-slate-400">
            <li className="flex items-center gap-2">
              <Phone className="h-3.5 w-3.5 text-[#FF6B00]" /> +91 98765 43210
            </li>
            <li className="flex items-center gap-2">
              <Mail className="h-3.5 w-3.5 text-[#FF6B00]" /> support@tripgo.com
            </li>
            <li className="flex items-center gap-2">
              <MapPin className="h-3.5 w-3.5 text-[#FF6B00]" /> Bilaspur, Chattisgarh
            </li>
          </ul>
        </div>
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 border-t border-slate-800 mt-12 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-500">
